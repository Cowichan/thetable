...
kudoz = Actualite.create!(user: boris, name: "Kudoz", url: "http://getkudoz.com", tagline: "Tinder for J", classification: "cinema")
...
le_wagon = Actualite.create!(user: seb, name: "medpics", url: "http://medpics.com", tagline: "Medpics", classification: "cinema")
